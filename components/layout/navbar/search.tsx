  ...
  return (
    <Form action="/search" className="w-max-[550px] relative w-full lg:w-80 xl:w-full">
      <input
        ...
        className="text-md w-full rounded-lg border border-neutral-200 bg-white px-4 py-2 text-text placeholder:text-neutral-500 focus:border-primary focus:ring-1 focus:ring-primary md:text-sm"
      />
